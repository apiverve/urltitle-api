...
```gradle
dependencies {
    implementation 'com.github.apiverve:urltitle-api:1.1.12'
}
```
...
```java
import com.apiverve.urltitle.URLTitleAPIClient;
import com.apiverve.urltitle.APIResponse;
import com.apiverve.urltitle.APIException;

// Initialize the client
URLTitleAPIClient client = new URLTitleAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/urltitle](https://docs.apiverve.com/ref/urltitle)
...
- **Documentation:** [https://docs.apiverve.com/ref/urltitle](https://docs.apiverve.com/ref/urltitle)
- **Issues:** [GitHub Issues](https://github.com/apiverve/urltitle-api/issues)
