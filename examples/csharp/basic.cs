/*
 * URL Title API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the URL Title API.
 * API Documentation: https://docs.apiverve.com/ref/urltitle
 */
    ...
    class URLTitleExample
    {
        ...
        static async Task<JsonDocument> CallURLTitleAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { url &#x3D; &quot;https://blog.apiverve.com/chuck-norris-api-how-to&quot; };
        ...
        {
            Console.WriteLine("📤 Calling URL Title API...\n");

            var result = await CallURLTitleAPI();
