// Package urltitle provides a Go client for the URL Title API.
//
// For more information, visit: https://apiverve.com/marketplace/urltitle?utm_source=go&utm_medium=readme
package urltitle
...
const (
	baseURL        = "https://api.apiverve.com/v1/urltitle"
	defaultTimeout = 30 * time.Second
)

// Client is the URL Title API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new URL Title API client.
...
// Execute makes a request to the URL Title API with typed parameters.
//
...
//   - url (required): string - The URL of the web page to get the title of [format: url]
